...
Provide full manual CRUD operations for expense line items — create, read, update, delete — with category filtering and receipt association, complementing the AI extraction flow.
